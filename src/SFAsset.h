 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN,  SFASSET_WALL, SFASSET_BARRICADE, SFASSET_GAMEOVER, SFASSET_START, SFASSET_NLIFE};
